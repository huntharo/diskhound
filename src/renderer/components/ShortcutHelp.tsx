...
const GROUPS: ShortcutGroup[] = [
  {
    ...
    items: [
      ...
      { keys: ["Ctrl", "4"], desc: "Dev artifacts" },
      { keys: ["Ctrl", "5"], desc: "Duplicates" },
      { keys: ["Ctrl", "6"], desc: "Changes" },
      { keys: ["Ctrl", "7"], desc: "Easy Move" },
      { keys: ["Ctrl", "8"], desc: "Processes" },
      { keys: ["Ctrl", "9"], desc: "Disk I/O" },
      { keys: ["Ctrl", "0"], desc: "Settings" },
